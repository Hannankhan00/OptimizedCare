...
export default function CareOverviewSection({
  ...
  return (
    <section id="care-overview" className="w-full py-16 md:py-24 bg-white border-b border-[#D2D2D7]">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-[#F5F5F7] hover:bg-[#EDEDED] transition-colors duration-300">
                  ...
                  <div>
                    <h4 className="text-[13px] font-semibold text-[#1D1D1F]">Supported Living Tenancies</h4>
                    <p className="text-[12px] text-[#6E6E73]">Autonomy, budgeting &amp; community life skills for adults.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-[#F5F5F7] hover:bg-[#EDEDED] transition-colors duration-300">
                  ...
                  <div>
                    <h4 className="text-[13px] font-semibold text-[#1D1D1F]">Daily Domiciliary Care</h4>
                    <p className="text-[12px] text-[#6E6E73]">Medication administration, meals &amp; personal hygiene visits.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-[#F5F5F7] hover:bg-[#EDEDED] transition-colors duration-300">
                  ...
                  <div>
                    <h4 className="text-[13px] font-semibold text-[#1D1D1F]">24/7 Live-in Carers</h4>
                    <p className="text-[12px] text-[#6E6E73]">Round-the-clock peace of mind with vetted resident carers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 p-3.5 rounded-xl bg-[#F5F5F7] hover:bg-[#EDEDED] transition-colors duration-300">
                  ...
                  <div>
                    <h4 className="text-[13px] font-semibold text-[#1D1D1F]">CQC Outstanding Oversight</h4>
                    <p className="text-[12px] text-[#6E6E73]">Direct payments, NHS CHC &amp; private referrals accepted.</p>
                  </div>
                </div>
              </div>
            </div>
