...
export default function SurgeryBookingSection() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    hospital: "24 Greek Street Suite, Stockport (SK3 8AB)",
    procedure: "Bespoke Breast Augmentation & Uplift",
    preferredTime: "Flexible (Next Available)",
    notes: "",
  });
    ...
    <section className="w-full py-16 md:py-24 bg-[#F8FAFC] border-b border-[#E2E8F0]">
      <div className="max-w-[1360px] mx-auto px-4 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          {/* Left Column: Guarantees & Reassurance */}
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#E8F6F3] border border-[#94D2BD] text-[#2A9D8F] text-[11px] font-semibold uppercase tracking-wider">
              ...
              <span>Direct Consultant Surgeon Access</span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1D3557] tracking-tight leading-tight">
              Arrange Your Private Surgical Consultation
            </h2>

            <p className="text-[16px] text-[#457B9D] leading-relaxed">
              Every surgical appointment is conducted directly by your operating BAAPS or BAPRAS accredited consultant plastic surgeon. We do not employ clinical sales coordinators or patient advisors.
            </p>
            ...
            <div className="space-y-4 pt-2">
              <div className="flex items-start gap-3 p-4 rounded-xl bg-white border border-[#E2E8F0]">
                ...
                <div>
                  <h4 className="text-[14px] font-semibold text-[#1D3557]">Direct 45-Minute Surgeon Evaluation</h4>
                  <p className="text-[12px] text-[#457B9D]">Candid anatomical assessment, Crisalix 3D simulation, and surgical planning.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-white border border-[#E2E8F0]">
                ...
                <div>
                  <h4 className="text-[14px] font-semibold text-[#1D3557]">Mandatory 14-Day Cooling-Off Period</h4>
                  <p className="text-[12px] text-[#457B9D]">No high-pressure sales or same-day deposits. Full ethical reflection guaranteed.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-white border border-[#E2E8F0]">
                ...
                <div>
                  <h4 className="text-[14px] font-semibold text-[#1D3557]">Comprehensive 2-Year Clinical Aftercare</h4>
                  <p className="text-[12px] text-[#457B9D]">All post-operative dressing changes, compression garments, and scheduled surgeon reviews included.</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2">
              <div className="flex items-center gap-2 text-[13px] text-[#457B9D]">
                <span>Prefer direct telephone concierge?</span>
                ...
                {submitted ? (
                  <div className="py-12 flex flex-col items-center text-center gap-4">
                    ...
                    <h3 className="text-2xl font-semibold text-[#1D3557]">
                      Surgical Consultation Registered
                    </h3>
                    <p className="text-[14px] text-[#457B9D] max-w-md leading-relaxed">
                      Thank you, {formData.name}. Our surgical concierge has received your request. A surgical coordinator will contact you via private line within 2 business hours to schedule your consultation with your named BAAPS/BAPRAS consultant surgeon.
                    </p>
                    <div className="text-[12px] font-mono text-[#1D3557] bg-[#E8F6F3] px-4 py-2 rounded-full border border-[#94D2BD]">
                      Reference: OC-SURG-{Math.floor(100000 + Math.random() * 900000)}
                    </div>
                    <button
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="flex items-center justify-between pb-3 border-b border-[#E2E8F0]">
                      <div>
                        ...
                        <p className="text-[12px] text-[#457B9D]">
                          BAAPS &amp; BAPRAS Consultant Plastic Surgeons
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          required
                          type="text"
                          placeholder="e.g. Lady Charlotte Hamilton"
                          value={formData.name}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full h-11 px-3.5 text-[13px] bg-white border border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#2A9D8F] text-[#1D3557] transition-all"
                        >
                          <option value="24 Greek Street Suite, Stockport (SK3 8AB)">24 Greek Street Surgical Suite, Stockport (SK3 8AB)</option>
                          <option value="Virtual Video Consultation">Virtual Video Consultation (GMC Specialist)</option>
                        </select>
                      </div>
                    </div>

                    {/* Procedure of Interest & Timeframe */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[11px] font-bold uppercase tracking-wider text-[#457B9D] mb-1.5">
                          Surgical Procedure
                        ...
                        <select
                          ...
                          className="w-full h-11 px-3.5 text-[13px] bg-white border border-[#E2E8F0] rounded-xl focus:outline-none focus:border-[#2A9D8F] text-[#1D3557] transition-all"
                        >
                          <option value="Bespoke Breast Augmentation & Uplift">Bespoke Breast Augmentation &amp; Uplift</option>
                          <option value="Preservation Rhinoplasty">Preservation Rhinoplasty (Piezo Ultrasonic)</option>
                          <option value="360 VASER Liposuction">360 VASER® Liposuction &amp; Body Contouring</option>
                          <option value="Deep Plane Facelift & Neck Lift">Deep Plane Facelift &amp; Neck Lift</option>
                          <option value="Gynecomastia (Male Chest)">Gynecomastia (Male Chest Reduction)</option>
                          <option value="Upper & Lower Blepharoplasty">Upper &amp; Lower Blepharoplasty</option>
                          <option value="General Surgical Consultation">General Plastic Surgery Consultation</option>
                        </select>
                      </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Saturday Morning Priority">Saturday Morning Priority</option>
                        </select>
                      </div>
                    </div>
                    ...
                    <div>
                      <label className="block text-[11px] font-bold uppercase tracking-wider text-[#457B9D] mb-1.5">
                        Clinical Goals / Medical History (Optional)
                      </label>
                      <textarea
                        rows={2}
                        placeholder="Please detail your surgical goals or previous operations..."
                    ...
                    <div className="pt-2">
                      ...
                      >
                        {loading ? (
                          ...
                          <>
                            <span>Request Consultant Surgeon Consultation</span>
